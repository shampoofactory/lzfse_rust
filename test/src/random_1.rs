// Random low entropy, mask: 0x02020202.
        ...
        mod $name {
            ...
            fn encode_decode_0() -> io::Result<()> {
                ...
                for seed in 0..0x0080 {
                    let vec = Iterator::take(Seq::masked(Rng::new(seed), 0x02020202), 0x0010_0000)
                        .collect::<Vec<_>>();
            ...
            fn encode_decode_1() -> io::Result<()> {
                ...
                for seed in 0..0x0800 {
                    let vec = Iterator::take(Seq::masked(Rng::new(seed), 0x02020202), 0x1000)
                        .collect::<Vec<_>>();
                    monkey.encode_decode(&vec, $encoder)?;
                }
                Ok(())
